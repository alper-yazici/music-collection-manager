...
record1 = Vinyl("Daft Punk", "Random Access Memories", 2013, "Electronic", "Columbia", "Germany", date(2026, 8, 14), Decimal("29.99"), "Bought new", Decimal("35.00"), "Near Mint", "Shelf 1", "88883716861", "Black", "Original Pressing", 12, 33, "LP")
...
album_results = collection.find_by_album("Sen Aglama")
